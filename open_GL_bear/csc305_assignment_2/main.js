...
function initTextures() {
    ...
    textureArray.push({}) ;
    loadFileTexture(textureArray[textureArray.length-1],"grassland.png") ;
    
    textureArray.push({}) ;
    loadFileTexture(textureArray[textureArray.length-1],"iron.png") ;
    ...
    textureArray.push({}) ;
    loadFileTexture(textureArray[textureArray.length-1],"bear.png") ;

    textureArray.push({}) ;
    loadFileTexture(textureArray[textureArray.length-1],"Bhead.png") ;
    textureArray.push({}) ;
    loadFileTexture(textureArray[textureArray.length-1],"wheel.png") ;
    textureArray.push({}) ;
    loadFileTexture(textureArray[textureArray.length-1],"cloud.png") ;
...
function render() {
    ...
    gPush() ;
    {
        gTranslate(6.5+Math.cos(0.5*TIME),-3,0) ;
        ...
        //arm1 -> Hierarchical level1
        gPush() ;
        {
            gTranslate(-1.4,1,0) ;
            gRotate(-(Math.cos(0.5*TIME)*60/3.14159),0,0,1) ;
            gTranslate(-0,-1,0) ;
            gTranslate(-0,2,0) ;
            setColor(vec4(1,1,0,1.0)) ;
            gScale(0.25,1.6,0.25);
            ...
            gPush() ;
            {
                //arm level2
                gTranslate(0,1.4,0) ;
                gRotate((Math.cos(0.5*TIME)*30/3.14159),0,0,1) ;
                gTranslate(-0,0,0) ;
                gTranslate(-1,0,0) ;
                setColor(vec4(1,1,0,1.0)) ;
                gScale(1.2,0.25,0.25);
                drawCube() ;
                gScale(0.8,4,4)
                ...
                {
                    gTranslate(-1,0,0) ;
                    gRotate(Math.cos(0.5*TIME)*60/3.14159-30,0,0,1) ;
                    gTranslate(-0,0,0) ;
                    gTranslate(0,-1,0) ;
                    setColor(vec4(1,1,0,1.0)) ;
    ...
    gPush() ;
    {
        ...
        gTranslate(6+Math.cos(0.5*TIME),-3.8,1.2) ;
        setColor(vec4(1,1,1,1.0)) ;
    ...
    //control room for excavator
    gPush() ;
    {



        gTranslate(7.5+Math.cos(0.5*TIME),-1.2,0) ;
    ...
    gPush() ;
    {
        ...
        gTranslate(1.3+2*Math.cos(0.5*TIME),-1.5,0) ;
    ...
    gPush() ;
    {
        gTranslate(-1+2*Math.cos(0.5*TIME),-1.5,0) ;
        setColor(vec4(0.5,0.3,0,1.0)) ;
        gScale(1,2,1);
        ...
        gTranslate(0,2,0) ;
        setColor(vec4(0.5,0.3,0,1.0)) ;
        gRotate(30*Math.cos(0.5*TIME),0,1,0) ;
        gScale(1,1,1);
        gl.activeTexture(gl.TEXTURE0);
    ...
    gPush() ;
    {
        gTranslate(-0.5+2*Math.cos(0.5*TIME),-3.5,0) ;
        setColor(vec4(0.5,0.3,0,1.0)) ;
        gScale(0.2,0.5,0.2);
        drawCube() ;
        gScale(5,2,5);
    ...
    gPush() ;
    {
        gTranslate(0.2+2*Math.cos(0.5*TIME),-1,0) ;
        setColor(vec4(0.5,0.3,0,1.0));
        gScale(0.5,0.2,0.2);
        drawCube() ;
        gScale(2,5,5);
    ...
    gPush() ;
    {
        ...
        gTranslate(5,4+Math.cos(0.5*TIME),0) ;
        setColor(vec4(0,0,1,1.0)) ;


        gScale(Math.cos(0.5*TIME),Math.cos(0.5*TIME),Math.cos(0.5*TIME));
        gl.activeTexture(gl.TEXTURE0);
